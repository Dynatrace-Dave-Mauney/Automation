...
def process_report(env, token, summary_mode):
    ...
    count_has_no_host_group_but_probably_should = 0
        ...
        for inner_entities_json in inner_entities_json_list:
            ...
            if host_group_name != 'No Host Group':
                ...
                if paas_vendor_type != 'AZURE_WEBSITES' and paas_vendor_type != 'AWS_ECS_FARGATE':
                    count_has_no_host_group_but_probably_should += 1
    ...
    if count_total > 0:
        summary.append(
            ...
            str(count_has_no_host_group_but_probably_should) + ' hosts do not have a host group and probably should.  ' +
    ...
    if not summary_mode:
        ...
        write_strings(['Hosts with Host Group: ' + str(count_has_host_group)])
        write_strings(['Hosts without Host Group: ' + str(count_has_no_host_group)])
        write_strings(['Hosts without Host Group (and probably should have one): ' + str(count_has_no_host_group_but_probably_should)])
