...
def process_report(env, token, summary_mode):
    ...
    raw_params = 'pageSize=4000&entitySelector=type(SYNTHETIC_TEST)&fields=+properties,+toRelationships&to=-24h'
