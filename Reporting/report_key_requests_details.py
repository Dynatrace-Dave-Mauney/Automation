...
def process_report(env, token, summary_mode):
    ...
    summary.append('There are ' + str(count_total) + ' key requests currently being monitored.  ')

    if not summary_mode:
        rows = sorted(rows)
        report_name = 'Key Requests-Service Methods'
        ...
        write_strings(['Total Key Requests: ' + str(count_total)])
