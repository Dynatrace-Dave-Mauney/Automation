...
def process_report(env, token, summary_mode):
    ...
    for oneagents_json in oneagents_json_list:
        ...
        for inner_oneagents_json in inner_oneagents_json_list:
            ...
            if not summary_mode:
                rows.append((str(display_name), str(discovered_name), str(entity_id), str(consumed_host_units)))
    ...
    if not summary_mode:
        ...
        report_headers = ('displayName', 'discoveredName', 'entityId', 'consumedHostUnits')
