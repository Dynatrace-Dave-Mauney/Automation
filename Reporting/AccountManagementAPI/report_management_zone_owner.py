...
def report_management_zones_in_environments():
    ...
    headers = ('Management Zone Name', 'ID', 'Tenant', 'Description')
    rows = []
    for management_zone in management_zones:
        ...
        management_zone_description = get_managment_zone_description(management_zone_parent, management_zone_id)
...
def get_managment_zone_description(parent, management_zone_id):
