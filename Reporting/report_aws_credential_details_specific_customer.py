...
def process(env, token, print_mode):
    ...
    params = ''
    aws_credentials_json_list = dynatrace_rest_api_helper.get_rest_api_json(env, token, endpoint, params)
    ...
    for aws_credentials_json in aws_credentials_json_list:
        ...
        params = ''
        aws_credentials = dynatrace_rest_api_helper.get_rest_api_json(env, token, endpoint, params)[0]
