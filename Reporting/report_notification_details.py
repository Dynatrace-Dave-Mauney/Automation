...
def process(env, token, print_mode):
    ...
    params = ''
    notifications_json_list = dynatrace_rest_api_helper.get_rest_api_json(env, token, endpoint, params)
    ...
    for notifications_json in notifications_json_list:
        ...
        for inner_notifications_json in inner_notifications_json_list:
            ...
            # params = ''
            # notification = dynatrace_rest_api_helper.get_rest_api_json(env, token, endpoint, params)[0]
