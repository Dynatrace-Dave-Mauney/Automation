...
GENERATED_PATH = '../DynatraceDashboardGenerator'
...
# PROD
ignore_list = [
    'AWS Supporting Services (Improved)',
    'Amazon ActiveMQ',
    'Amazon Athena',
...
#     'AWS WorkSpaces',
# ]
# ignore_list = ['Generated Dashboards Menu','AWS Supporting Services Menu', 'AWS Supporting Services (Improved)']
...
# always ignore the id itself
ignore_list.append(GENERATED_ID)
...
for filename in glob.glob(path):
    with open(filename, 'r', encoding='utf-8') as f:
        ...
        # print(compare_name)
        if dashboard_name not in ignore_list and dashboard_id not in ignore_list:
