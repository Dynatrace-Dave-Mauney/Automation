...
def main():
	dashboard_links = [
		...
		# Use list_aws_and_amazon_dashboards.py to generate a full list or
		# Use list_dynatrace_owned_dashboards.py to generate a full list
		...
		# Use list_aws_and_amazon_dashboards.py to regenerate full list
		('AWS API Gateway', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000002'),
		('AWS AZ', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000003'),
		('AWS Amazon MQ', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000004'),
		('AWS Aurora', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000005'),
		('AWS Cloudfront', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000006'),
		('AWS Connect', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000007'),
		('AWS Container Insights', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000008'),
		('AWS DynamoDB', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000009'),
		('AWS EC', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000010'),
		('AWS ECS', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000011'),
		('AWS EFS', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000012'),
		('AWS ES', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000013'),
		('AWS Events', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000014'),
		('AWS Kafka', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000015'),
		('AWS Kinesis Data Firehose', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000016'),
		('AWS Lambda 1', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000017'),
		('AWS Lambda 2', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000018'),
		('AWS Logs', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000019'),
		('AWS Nat Gateways', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000020'),
		('AWS RDS 2', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000021'),
		('AWS Route53', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000022'),
		('AWS S3', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000023'),
		('AWS SNS', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000024'),
		('AWS SQS', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000025'),
		('AWS SageMaker', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000026'),
		('AWS Textract', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000027'),
		('AWS Usage', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000028'),
		('AWS WAFv2', '#dashboard;id=aaaaaaaa-bbbb-cccc-dddd-000000000029'),
	]
