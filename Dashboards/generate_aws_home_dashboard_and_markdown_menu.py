...
def main():
	dashboard_links = [
		...
		# These are derived from DynatraceDashboardGenerator:
		...
		('AWS Amazon MQ', '#dashboard;id=00000000-dddd-bbbb-ffff-000000001029'),
		...
		('AWS Container Insights', '#dashboard;id=00000000-dddd-bbbb-ffff-000000001013'),
		...
		('AWS Kafka', '#dashboard;id=00000000-dddd-bbbb-ffff-000000001113'),
		('AWS Kinesis Data Firehose', '#dashboard;id=00000000-dddd-bbbb-ffff-000000001031'),
		('AWS Lambda Functions', '#dashboard;id=00000000-dddd-bbbb-ffff-000000001005'),
		('AWS Logs', '#dashboard;id=00000000-dddd-bbbb-ffff-000000001028'),
		('AWS Nat Gateways', '#dashboard;id=00000000-dddd-bbbb-ffff-000000001015'),
		('AWS RDS 1', '#dashboard;id=00000000-dddd-bbbb-ffff-000000001007'),
		('AWS RDS 2', '#dashboard;id=00000000-dddd-bbbb-ffff-000000001032'),
