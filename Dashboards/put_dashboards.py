...
def run():
    ...
    # put_dashboards('Personal', 'Templates/Overview/00000000-dddd-bbbb-ffff-000000000807-v2.json', 'Personal', owner)
    ...
    # put_dashboards('NonProd', 'Custom/Overview-Customer2-NonProd (With Prod Tags)/00000000-dddd-bbbb-ffff-000000000807-v1.json', None, owner)
    ...
    # put_dashboards('Prod', 'Custom/Overview-Customer2-Prod/00000000-dddd-bbbb-ffff-000000000807-v1.json', None, owner)
    ...
    # put_dashboards('Prod', '../DynatraceDashboardGenerator/aaaaaaaa-bbbb-cccc-dddd-000000000002.json', 'TEMP', owner)
    # put_dashboards('Prod', '../DynatraceDashboardGenerator/aaaaaaaa-bbbb-cccc-dddd-000000000003.json', 'TEMP', owner)
    # put_dashboards('Prod', '../DynatraceDashboardGenerator/aaaaaaaa-bbbb-cccc-dddd-000000000004.json', 'TEMP', owner)
    # put_dashboards('Prod', '../DynatraceDashboardGenerator/aaaaaaaa-bbbb-cccc-dddd-000000000005.json', 'TEMP', owner)
    # put_dashboards('Prod', '../DynatraceDashboardGenerator/aaaaaaaa-bbbb-cccc-dddd-000000000006.json', 'TEMP', owner)
    # put_dashboards('Prod', '../DynatraceDashboardGenerator/aaaaaaaa-bbbb-cccc-dddd-000000000007.json', 'TEMP', owner)
    # put_dashboards('Prod', '../DynatraceDashboardGenerator/aaaaaaaa-bbbb-cccc-dddd-000000000008.json', 'TEMP', owner)
    # put_dashboards('Prod', '../DynatraceDashboardGenerator/aaaaaaaa-bbbb-cccc-dddd-000000000030.json', 'TEMP', owner)
