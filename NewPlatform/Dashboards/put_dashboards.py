...
def run():
    ...
    # put_dashboards('Personal', 'Assets/Key*.json')
    # put_dashboards('Personal', 'Downloads/Personal/ActiveGate*.json')
    put_dashboards('Personal', 'Downloads/Personal/List Entity - Disks*.json')
