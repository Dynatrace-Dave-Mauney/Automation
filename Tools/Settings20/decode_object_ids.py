...
def test():
    for object_id in object_ids:
        schema_id = extract_schema_id_from_object_id(object_id)
        print(f'Object ID: {object_id} -> SchemaId: {schema_id}')


def test_update_token():
    for object_id in tu_object_ids:
        update_token = get_update_token(object_id)
        entity_id = extract_entity_id_from_object_id(update_token)
        print(f'Object ID: {object_id} -> Update Token: {update_token} -> Entity Id: {entity_id}')
